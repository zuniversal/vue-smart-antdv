    ...
    (r = {
      ...
      c6d2: function(e, t, n) {
        ...
        e.exports = function(e, t, n, r, o, a, c) {
          ...
          if (
            ...
            if (
              ((i = { values: u(A), keys: a ? d : u('keys'), entries: u(F) }),
              c)
            )
              for (f in i) (!I && !l && f in s) || w(s, f, i[f]);
            else v({ target: t, proto: !0, forced: I || l }, i);
          return (
            (h && !c) || s[E] === d || w(s, E, d, { name: o }), (C[t] = d), i
          );
        };
      },
      c8ba: function(e, t) {
      ...
      d9f5: function(D, L, e) {
        ...
        function r(e, t) {
          var n = (A[e] = h(I));
          return (
            te(n, { type: T, tag: e, description: t }),
            s || (n.description = t),
            n
          );
        }
                              ...
                              return [
                                Object(F.createVNode)(
                                  ...
                                  },
                                  {
                                    default: function() {
                                      return [
                                        Object(F.createTextVNode)('Submit'),
                                      ];
                                    },
                                  },
                                ),
